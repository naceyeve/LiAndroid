...
import com.naceyeve.liandroid.util.NetWorkUtil;
...
public class ApiManage {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (NetWorkUtil.isNetWorkAvailable(MyApplication.getContext())) {
                ...
                return originalResponse.newBuilder()
                        ...
                        .build();//通过添加请求头缓存数据，apikey也可以在这里添加到请求头
            } else {
    ...
    public ApiStore ganK;

    public ApiStore getGankService() {
        if (ganK == null) {
    ...
    public ApiStore zhihuApi;
    public ApiStore getZhihuApiService() {
        if (zhihuApi == null) {
            synchronized (zhihuMonitor) {
                if (zhihuApi == null) {
